...
set ytics ("aws.ctm" 1,"whisper.ctm" 2,"google.ctm" 3,"azure.ctm" 4,"rev.ctm" 5,"ibm.ctm" 6,"whispercpp.ctm" 7,"nemo.ctm" 8)
plot "Ensemble.grange2.sys.mean" using 2:1 title "Mean Speaker Word Error Rate (%)" with lines,\
     ...
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%lf" title "0.035"
