...
set ytics ("aws.ctm" 1,"rev.ctm" 2,"azure.ctm" 3,"google.ctm" 4,"whisper.ctm" 5,"whispercpp.ctm" 6,"nemo.ctm" 7,"ibm.ctm" 8)
plot "Ensemble.grange2.sys.mean" using 2:1 title "Mean Speaker Word Error Rate (%)" with lines,\
     ...
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%lf" title "unknown1"
