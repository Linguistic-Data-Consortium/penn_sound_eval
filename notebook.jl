...
begin
	plot(sort(wers.ibm),label="ibm", linestyle=:solid, color=:black)
	plot!(sort(wers.google),label="google", linestyle=:solid, color=:tan)
	plot!(sort(wers.nemo),label="nemo", linestyle=:dashdotdot, color=:green)
	plot!(sort(wers.whispercpp),label="whispercpp", linestyle=:dash, color=:blue)
	plot!(sort(wers.azure),label="azure", linestyle=:solid, color=:darkgray)
	plot!(sort(wers.aws),label="aws",xlim=(0,101),ylim=(0,90), linestyle=:dashdotdot,color=:red)
	plot!(sort(wers.whisper),label="whisper", linestyle=:dash, color=:magenta)
	plot!(sort(wers.rev),label="rev", linestyle=:solid,color=:black)
end
...
begin
	w1 = wers_sorted_by_rev
	plot(w1.ibm,label="ibm", linestyle=:solid, color=:black)
	plot!(w1.google,label="google", linestyle=:solid, color=:tan)
	plot!(w1.nemo,label="nemo", linestyle=:dashdotdot, color=:green)
	plot!(w1.whispercpp,label="whispercpp", linestyle=:dash, color=:blue)
	plot!(w1.azure,label="azure", linestyle=:solid, color=:darkgray)
	plot!(w1.aws,label="aws",xlim=(0,101),ylim=(0,90), linestyle=:dashdotdot,color=:red)
	plot!(w1.whisper,label="whisper", linestyle=:dash, color=:magenta)
...
begin
	...
	plot(w2.ibm,label="ibm", linestyle=:solid, color=:black)
	plot!(w2.google,label="google", linestyle=:solid, color=:tan)
	plot!(w2.nemo,label="nemo", linestyle=:dashdotdot, color=:green)
	plot!(w2.whispercpp,label="whispercpp", linestyle=:dash, color=:blue)
	plot!(w2.azure,label="azure", linestyle=:solid, color=:darkgray)
	plot!(w2.aws,label="aws",xlim=(0,101),ylim=(0,90), linestyle=:dashdotdot,color=:red)
	plot!(w2.whisper,label="whisper", linestyle=:dash, color=:magenta)
